...
@Component({
  ...
  template: `
      <article>
          ...
          You are the sole owner of content and solely responsible for the content of all communications using your account. You must comply with all laws while using the Service; you must not transmit any communication that violates any law, court order or regulation; you must not violate any third party rights in using the Service; and you must not use the Service in any way that damages, interferes with, or disrupts OnDaMenu’s system or other users. We may suspend any such communications. You understand and agree that your use of the Service and any content is solely at your own risk.

          Consent to Receive Email

          By establishing a paid or trial account with OnDaMenu, you consent to receive email communication from us concerning services including without limitation, sign up confirmation receipts, installation guides, notices of service updates and other correspondence required for administration of the Service. We expect to communicate with you as necessary via email and the OnDaMenu website.

          Resale and Transfer

          You are expressly prohibited from reselling or transferring the Service and/or software to any other person for any purpose, without express written permission from OnDaMenu in advance.

          Unlawful and Prohibited Use

          You agree to use the Service only for lawful purposes. You are expressly prohibited from using the Service to transmit or receive any communication or material of any kind when in OnDaMenu’ sole judgment the transmission, receipt, or possession of such communication or material would constitute, or encourages conduct that would constitute, a criminal offense, give rise to a civil liability, or otherwise violate any applicable laws. You are expressly prohibited from using the Service for any abusive or fraudulent purpose, including using the Service in a way that interferes with our ability to provide the Service to you or other customers or avoids your obligation to pay for communications services. OnDaMenu, in its sole discretion, may terminate your Service without advance notice if it believes you have violated the aforementioned restrictions, or if you act in a manner that is threatening, obscene, harassing, or abusive to OnDaMenu personnel. You are liable for any and all use of the Service by any person using the Service provided to you and agree to indemnify and hold harmless OnDaMenu against any and all liability for any such use. If OnDaMenu, in its sole discretion, believes that you have violated the aforementioned restrictions, OnDaMenu may forward personally identifiable information to the appropriate authorities for investigation and prosecution and you hereby consent to such forwarding.
          ...
          You agree to notify OnDaMenu immediately if you become aware at any time that your Service is being stolen or fraudulently used, or access to your,identification codes or security codes has been compromised. You must provide a detailed description of the circumstances of the theft or stolen or fraudulent use of the Service and supply any additional documentation reasonably requested by OnDaMenu. Failure to do so in a timely manner may result in the termination of your Service and additional charges.
          ...
          After the free trial, refunds are only available due to a service disruption and are at the discretion of OnDaMenu.
          ...
          Failure by OnDaMenu to insist upon strict performance of any terms or conditions of this Agreement or failure or delay to exercise any rights or remedies provided herein or by law shall not release you from any of the warranties of obligations of this Agreement, and shall not be deemed a waiver of any right of OnDaMenu to insist upon strict performance hereof or any of its rights and remedies.
          ...
          OnDaMenu may change this Agreement from time to time. Any changes will be posted at the Terms of Use section of the OnDaMenu website (http://www.4leaflabs.com/terms-of-use). Notice will be considered received by you and any such changes will become binding and effective on the date the changes are posted to the OnDaMenu website, except in the case of changes to the prices or charges, when we will comply with our notice commitments described above. ASIDE FROM PRICING CHANGES, IF YOU CONTINUE TO BE ENROLLED IN, USE, OR PAY FOR THE SERVICE AFTER ANY CHANGES IN THE TERMS OR CONDITIONS, YOU AGREE TO THE CHANGES. The Agreement as posted supersedes all previously agreed to electronic and written terms of service.
          * FAQ
          * Getting Started
          * Terms of Use
          * Privacy Policy
          Copyright © 2020 OnDaMenu Inc. All Rights Reserved
          </p>
      </article>
